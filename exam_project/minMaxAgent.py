...
class GameNode:
    ...
    @staticmethod
    def __get_available_moves(ply_id, current_board):
    ...
    def __compute_tree__(self):
        for move in self.available_moves:
            ...
            self.__add_children__(GameNode(self.game, move, GameNode.__get_available_moves(self.ply_id, child),self.ply_id, self ))
...
class minMaxPlayer(Player):
    def __init__(self) -> None:
        ...
        self.root = GameNode(game.get_board(), None, GameNode.__get_available_moves(self.id, game.get_board()), None)  # GameNode
        self.game_tree = GameTree(self.root)  # GameTree
